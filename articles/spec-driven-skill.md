...
設定はプロジェクトごとに持てるので、「このプロジェクトは全部 md でいい」「ここは技術解説だけ HTML にしたい」といった使い分けもできます。テストケースのように、レビューUI として扱うぶん常に HTML で出したいものは、設定に関係なく強制的に `.html` にする、という例外もスキル側で持っています。
...
### 7. PreCompactフックで「計画中である」ことを再周知する
